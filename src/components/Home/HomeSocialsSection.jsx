...
const HomeSocialsSection = () => {
  return (
    <div className='flex gap-10 justify-center items-center'>
        ...
        <a href="https://www.instagram.com" className='w-[50px] h-[50px] object-contain' target={"_blank"}>
            <Image className="" src="/vectors/instagram.svg" alt="Instagram Logo, link to the Prattic's Instagram" width={50} height={50}/>
        </a>

        <a href="https://www.twitter.com" className='w-[50px] h-[50px] object-contain' target={"_blank"}>
